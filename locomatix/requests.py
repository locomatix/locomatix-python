...
ROUTE_SIGNATURES = {
  'CreateObject':     ( 'POST',   '/feed/%s/object/Create',           ['feed'] ),
  'DeleteObject':     ( 'DELETE', '/feed/%s/object/Delete',           ['feed'] ),
  'ListObjects':      ( 'GET',    '/feed/%s/ListObjects',             ['feed'] ),
  'GetAttributes':    ( 'GET',    '/feed/%s/object/GetAttributes',    ['feed'] ),
  'UpdateAttributes': ( 'PUT',    '/feed/%s/object/UpdateAttributes', ['feed'] ),
  'GetLocation':      ( 'GET',    '/feed/%s/object/GetLocation',      ['feed'] ),
  'UpdateLocation':   ( 'PUT',    '/feed/%s/object/UpdateLocation',   ['feed'] ),
  'SearchRegion':     ( 'GET',    '/search/Region',                   None     ),
  'SearchNearby':     ( 'GET',    '/search/NearbyObject',             None     ),
  'CreateZone':       ( 'POST',   '/zone/%s/Create',                  ['feed'] ),
  'GetZone':          ( 'GET',    '/zone/%s/Get',                     ['feed'] ),
  'ListZones':        ( 'GET',    '/zone/%s/List',                    ['feed'] ),
  'DeleteZone':       ( 'DELETE', '/zone/%s/Delete',                  ['feed'] ),
